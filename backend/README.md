...
## Project Structure
    ...
    ├── komatsu_hat_simulat_36289  # Django project configurations
...
1. Clone this repo and `cd komatsu_hat_simulat_36289`
...
2. Clone this repo and `cd komatsu_hat_simulat_36289`
